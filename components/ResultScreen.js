  ...
  return (
    <div className='w-full h-full bg-white flex flex-col max-w-[400px] shadow-lg pt-[70px] pb-[30px] rounded-tl-[20px] rounded-tr-[20px] justify-between items-center'>
      <div className=' w-[88%]'>
        ...
        <div className=' mt-3 border border-gray-300 mx-auto my-0 bg-white w-[100px] h-[100px] rounded-full shadow-xl flex justify-center items-center' > <p className=' font-bold font-serif text-xl'> {score}%</p></div>
